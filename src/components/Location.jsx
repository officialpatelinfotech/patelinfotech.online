...
const Location = () => {
  return (
    <div className="location-container">
      ...
      >
        {/* Heading */}
        <motion.h1 variants={fadeUp}>Our Office Location</motion.h1>

        <motion.p variants={fadeUp} className="location-subtitle">
          Visit Patel Infotech at our registered office in Maharashtra.
        </motion.p>

        {/* Address Section */}
        <motion.div className="location-details" variants={fadeUp}>
        ...
        {/* Google Map (NO API KEY REQUIRED) */}
        <motion.div
        ...
        >
          <a
            href="https://www.google.com/maps/search/?api=1&query=Tipsy,+Topsy+Co.+Op.+Society,+Ulhasnagar+421004"
            target="_blank"
